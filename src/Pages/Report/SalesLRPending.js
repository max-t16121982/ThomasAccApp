...
const SalesLRPending = () => {
    ...
    const shoot = async () => {
        ...
        if (AccName == undefined) {
            alert("Ref. Account Name is not found..")
            return null;
        }
    ...
    return (
        <div className="App" style={{ marginLeft: '10px', marginRight: '10px' }}>
            <h2 style={{ color: 'Blue' }}>Sales LR Pending</h2>
            ...
            <table  >
                <thead>
                    ...
                    <th style={{ border: '2px solid green' }}>Account</th>
                    <th style={{ border: '2px solid green' }}>Transport</th>
                    <th style={{ textAlign: 'right', border: '2px solid green' }}>Amount</th>
                    <th style={{ textAlign: 'left', border: '2px solid green' }}>LR Number</th>
                    {/* <th>CrAmount</th> */}
                </thead>
                <tbody >
                    {search.map((d) => (
                        <tr key={d}>
                            ...
                            <td style={d.BILL == 'Total' ? { fontWeight: 'bold', textAlign: 'center', width: "15%", border: '2px solid green' } : { textAlign: 'center', width: "15%", border: '2px solid green' }}>{d.AC_NAME_1}</td>
                            <td style={d.BILL == 'Total' ? { fontWeight: 'bold', textAlign: 'center', width: "15%", border: '2px solid green' } : { textAlign: 'center', width: "15%", border: '2px solid green' }}>{d.TrnsName}</td>
                            ...
                            <td style={d.BILL == 'Total' ? { fontWeight: 'bold', textAlign: 'right', width: "25%", border: '2px solid green' } : { textAlign: 'right', width: "25%", border: '2px solid green' }}></td>
                        </tr>
                    ))}
                </tbody>
            </table>
